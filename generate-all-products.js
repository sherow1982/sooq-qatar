// Generate all product pages with Header & Footer embedded
// Execute: node generate-all-products.js
...
function generateProduct(p) {
    ...
    const whatsapp = encodeURIComponent(`أنا مهتم بـ: ${p.title}\nالسعر: ${p.sale} QAR\nSKU: ${p.sku}`);
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-links a { color: white; text-decoration: none; font-weight: 500; padding: 0.5rem 0.8rem; border-radius: 5px; }
        ...
        .product-image { width: 100%; height: auto; object-fit: contain; padding: 1rem; background: #f5f5f5; border-radius: 12px; }
        ...
        <div class="product-hero">
            ...
            <div class="product-details">
                ...
                <div class="price-section">
                    ...
                    <div class="savings">📉 توفير: ${(p.price - p.sale).toFixed(2)} QAR (-${discount}%)</div>
                </div>

                <div class="buttons">
                    <button class="btn btn-cart">🛒 أضف إلى السلة</button>
                    <a href="https://wa.me/201110760081?text=${whatsapp}" target="_blank" class="btn btn-whatsapp">📱 واتساب</a>
                </div>
            </div>
        </div>
    </div>
...
console.log(`\n✨ تم توليد ${products.length} صفحة منتج كاملة مع Header و Footer!\n`);