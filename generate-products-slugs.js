// سكريبت توليد صفحات المنتجات بأسماء سلاج + تصميم مبهر
// نفذ: node generate-products-slugs.js
...
console.log('\n🚀 بدء توليد صفحات المنتجات بتصميم مبهر...\n');
...
<head>
    ...
    <title>${product.title} | سوق قطر - أفضل الأسعار</title>
    <meta name="description" content="${product.title} - السعر: ${product.sale_price} QAR. منتج أصلي بضمان. متجر قطر الإلكتروني الموثوق.">
    <meta name="keywords" content="${product.title}, شراء أونلاين, قطر, ${product.sku}">
    <meta property="og:title" content="${product.title}">
    <meta property="og:description" content="اشتري ${product.title} بسعر ${product.sale_price} QAR مع ضمان وتوصيل آمن">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(135deg, var(--qatar-light) 0%, #f0f0f0 100%);
            line-height: 1.6;
        }
        header {
        ...
        .breadcrumb a { color: var(--qatar-maroon); text-decoration: none; }
        ...
        .savings { color: #4CAF50; font-weight: bold; font-size: 1.1rem; }
        .qty-section {
            display: flex;
            gap: 1rem;
            align-items: center;
        ...
        .qty-section label { font-weight: bold; }
        .qty-section input {
            width: 80px;
            padding: 0.8rem;
        ...
        .specs h3 { color: var(--qatar-maroon); margin-bottom: 1.5rem; font-size: 1.5rem; }
        ...
        .reviews h3 { color: var(--qatar-maroon); margin-bottom: 1.5rem; font-size: 1.5rem; }
        .review {
            padding: 1.5rem;
            border-left: 4px solid var(--qatar-gold);
            margin-bottom: 1.5rem;
...
<body>
    ...
    <div class="container">
        ...
        <div class="product-hero">
            ...
            <div class="product-details">
                ...
                <div class="rating">
                    ...
                    <span class="rating-text">(4.8 من 5)</span>
                </div>
        ...
        <div class="specs">
            ...
            <ul class="spec-list">
                ...
                <li>سياسة استرجاع ميسرة بدون تعقيدات</li>
            </ul>
        </div>

        <div class="reviews">
            <h3>⭐ تقييمات العملاء الحقيقيين</h3>
            ${reviewsHtml}
        </div>
    </div>
    ...
    <footer>
        ...
        <p>📱 +201110760081 | 📧 sherow1982@gmail.com</p>
    </footer>
    ...
    console.log(`✅ ${slug}.html - ${product.title}`);
});

console.log(`\n✨ تم توليد ${productsData.length} صفحة منتج بتصميم مبهر!`);
console.log(`📁 الملفات موجودة في: ./products-pages/\n`);
console.log('📤 الآن نفذ:');
console.log('   git add products-pages/');
console.log('   git commit -m "🎨 صفحات المنتجات - تصميم مبهر مع أسماء سلاج"');
